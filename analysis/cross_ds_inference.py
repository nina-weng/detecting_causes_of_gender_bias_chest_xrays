...
from dataloader.dataloader import NIHDataResampleModule,CheXpertDataResampleModule
...
def main(args,d,rs,f_perc):
    ...
    ckpt_dir_chexpert = run_dir + run_config_chexpert + f'/version_{version_no_chexpert}/checkpoints/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--run_dir', default='/work3/ninwe/run/cause_bias/', help='your run dir', type=str)
    parser.add_argument('-q', '--data_dir', default='/work3/ninwe/dataset/', help='your data dir', type=str)
